...
!function (a) {
    ...
    var b = {
        init: function (b) {
            var c = a.extend({}, a.fn.loadingOverlay.defaults, b), d = a(this).addClass(c.loadingClass),
                e = '<div class="' + c.overlayClass + '"><p class="' + c.spinnerClass + '"><img src="../files/icon/icon-kiselgroup.png" class="' + c.iconClass + '"><span class="' + c.textClass + '">' + c.loadingText + "</span></p></div>";
